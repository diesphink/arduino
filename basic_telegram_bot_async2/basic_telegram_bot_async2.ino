...
const char* ssid  =  "LulaLivre";     // SSID WiFi network
const char* pass  =  "batatinha";     // Password  WiFi network
const char* token =  "8063062948:AAEjWH10R7-t10UUWxsCHcxF9TI2JeDSMUc";  // Telegram token

// Target user can find it's own userid with the bot @JsonDumpBot
// https://t.me/JsonDumpBot
int64_t userid = 28225701;  


// Name of public channel (your bot must be in admin group)
const char* channel = "@FrankieJustABot";
